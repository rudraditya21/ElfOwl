...
type JA3Metadata struct {
	...
	// ANCHOR: SNI extraction from server_name extension - Feature: cert probing - Apr 26, 2026
	SNI string
}

// ParseJA3Metadata parses a TLS ClientHello and returns JA3 metadata.
// It accepts either a raw ClientHello handshake body or a full TLS record.
...
// ExtractTLSClientHello parses a ClientHello and returns JA3 component lists.
// The input should be the ClientHello handshake message body.
...
// Walks the extensions block of a normalised ClientHello body and returns the first SNI hostname.
